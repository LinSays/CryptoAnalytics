        ...
        <div class="bg-image" style="background-image: url('assets/media/photos/photo8@2x.jpg');">
          <div class="bg-black-op-75">
            <div class="content content-top content-full text-center">
              <div class="py-20">
                <h1 class="h2 font-w700 text-white mb-10">New Crypto</h1>
        ...
        <div class="bg-body-light border-b">
          <div class="content py-5 text-center">
            <nav class="breadcrumb bg-body-light mb-0">
              ...
              <span class="breadcrumb-item active">New Crypto</span>
            </nav>
          </div>
        </div>
        <!-- END Breadcrumb -->
              ...
              <div class="block block-rounded block-themed">
                ...
                <div class="block-content block-content-full">
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="crypto_name" name="crypto_name" placeholder="Crypto Name" value="">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="crypto_price" name="crypto_price" placeholder="Price in USD.." value="">
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="crypto_total" name="crypto_total" placeholder="Crypto Total Supply" value="">
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="crypto_market" name="crypto_market" placeholder="Crypto Market Cap" value="">
                    </div>
                  </div>
                </div>
              </div>
                ...
                success: function(response){
                  if(response != 0){
                      ...
                      $.ajax({
                          url: '../controller.php',
                          type: 'post',
                          data: {name:name, price:price, total:total, marketcap:marketcap, logo:response,post_type:"new_crypto"},
